...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/logo.png", "assets/logo.png");
		type.set ("assets/logo.png", AssetType.IMAGE);
		path.set ("assets/button-down.png", "assets/button-down.png");
		type.set ("assets/button-down.png", AssetType.IMAGE);
		path.set ("assets/button-up.png", "assets/button-up.png");
		type.set ("assets/button-up.png", AssetType.IMAGE);
		...
		id = "assets/button-down.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/button-up.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
